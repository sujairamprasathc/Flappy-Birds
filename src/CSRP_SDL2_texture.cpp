...
bool SDL2Texture::loadFromRenderedText(std::string textureText,
                                       SDL_Color textColor, int wrapLength) {
  // Get rid of preexisting texture
  free();
...
void SDL2Texture::render(int x, int y, SDL_Rect* clip, double angle,
...
int SDL2Texture::getWidth() { return mWidth; }

int SDL2Texture::getHeight() { return mHeight; }
